...
* Clone repository https://github.com/mlytvyn/ygroovypatches to your `hybris/bin/custom`
* Add `groovypatches` & `ygroovypatches` in the `localextensions.xml`
...
* Remove `ygroovypatches` extension from the disc and `localextensions.xml`
