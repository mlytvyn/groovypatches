...
public class DefaultPatchContextFactory implements PatchContextFactory<GlobalContext, PatchContext<GlobalContext>> {

    @Resource(name = "configurationService")
    private ConfigurationService configurationService;

    @Override
    public PatchContext<GlobalContext> createContext(final GlobalContext globalContext, final ReleaseContext release, final String patchNumber, final String patchId) {
